...
def test_public_get_ticker(client_admin_wallet):
    ...
    response = client_admin_wallet.public.get_ticker(params=params)
...
def test_account_get_subaccount(client_admin_wallet):
    subaccount = client_admin_wallet.account.get_subaccount()
