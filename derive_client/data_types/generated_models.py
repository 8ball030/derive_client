...
class PrivateCancelAllResponseSchema(Struct):
    id: Union[str, int]
    result: Result
...
class PrivateGetCollateralsParamsSchema(Struct):
    subaccount_id: int
...
class PrivateGetAllPortfoliosParamsSchema(Struct):
    wallet: str
...
class PrivateGetSubaccountParamsSchema(PrivateGetCollateralsParamsSchema):
    pass


class PrivateSessionKeysParamsSchema(PrivateGetAllPortfoliosParamsSchema):
    pass
...
class PrivateGetOpenOrdersParamsSchema(PrivateGetCollateralsParamsSchema):
    pass
...
class PrivateGetAccountParamsSchema(PrivateGetAllPortfoliosParamsSchema):
    pass
...
class PublicGetTradeHistoryParamsSchema(Struct):
    ...
    instrument_type: Optional[AssetType] = None
    page: int = 1
    page_size: int = 100
    subaccount_id: Optional[int] = None
...
class PrivateGetOptionSettlementHistoryParamsSchema(PrivateGetCollateralsParamsSchema):
    pass
...
class PrivateCancelAllTriggerOrdersParamsSchema(PrivateGetCollateralsParamsSchema):
    pass


class PrivateCancelAllTriggerOrdersResponseSchema(PrivateCancelAllResponseSchema):
    pass
...
class PrivateGetSubaccountsParamsSchema(PrivateGetAllPortfoliosParamsSchema):
    pass
...
class PrivateCancelRfqResponseSchema(PrivateCancelAllResponseSchema):
    pass
...
class PrivateSetCancelOnDisconnectResponseSchema(PrivateCancelAllResponseSchema):
    pass
...
class PrivateGetPositionsParamsSchema(PrivateGetCollateralsParamsSchema):
    pass
...
class PrivateResetMmpResponseSchema(PrivateCancelAllResponseSchema):
    pass
...
class PublicGetCurrencyResultSchema(Struct):
    ...
    borrow_apy: Decimal
    currency: str
    instrument_types: List[AssetType]
