...
class InvalidReason(str, Enum):
    Account_is_currently_under_maintenance_margin_requirements__trading_is_frozen_ = 'Account is currently under maintenance margin requirements, trading is frozen.'
    This_order_would_cause_account_to_fall_under_maintenance_margin_requirements_ = 'This order would cause account to fall under maintenance margin requirements.'
    Insufficient_buying_power__only_a_single_risk_reducing_open_order_is_allowed_ = 'Insufficient buying power, only a single risk-reducing open order is allowed.'
    Insufficient_buying_power__consider_reducing_order_size_ = 'Insufficient buying power, consider reducing order size.'
