...
class PublicAPI:
    ...
    def build_register_session_key_tx(self, params: PublicBuildRegisterSessionKeyTxParamsSchema,) -> PublicBuildRegisterSessionKeyTxResponseSchema:
    ...
    def register_session_key(self, params: PublicRegisterSessionKeyParamsSchema,) -> PublicRegisterSessionKeyResponseSchema:
    ...
    def deregister_session_key(self, params: PublicDeregisterSessionKeyParamsSchema,) -> PublicDeregisterSessionKeyResponseSchema:
    ...
    def login(self, params: PublicLoginParamsSchema,) -> PublicLoginResponseSchema:
    ...
    def statistics(self, params: PublicStatisticsParamsSchema,) -> PublicStatisticsResponseSchema:
    ...
    def get_all_currencies(self, params: PublicGetAllCurrenciesParamsSchema,) -> PublicGetAllCurrenciesResponseSchema:
    ...
    def get_currency(self, params: PublicGetCurrencyParamsSchema,) -> PublicGetCurrencyResponseSchema:
    ...
    def get_instrument(self, params: PublicGetInstrumentParamsSchema,) -> PublicGetInstrumentResponseSchema:
    ...
    def get_all_instruments(self, params: PublicGetAllInstrumentsParamsSchema,) -> PublicGetAllInstrumentsResponseSchema:
    ...
    def get_instruments(self, params: PublicGetInstrumentsParamsSchema,) -> PublicGetInstrumentsResponseSchema:
    ...
    def get_ticker(self, params: PublicGetTickerParamsSchema,) -> PublicGetTickerResponseSchema:
    ...
    def get_latest_signed_feeds(self, params: PublicGetLatestSignedFeedsParamsSchema,) -> PublicGetLatestSignedFeedsResponseSchema:
    ...
    def get_option_settlement_prices(self, params: PublicGetOptionSettlementPricesParamsSchema,) -> PublicGetOptionSettlementPricesResponseSchema:
    ...
    def get_spot_feed_history(self, params: PublicGetSpotFeedHistoryParamsSchema,) -> PublicGetSpotFeedHistoryResponseSchema:
    ...
    def get_spot_feed_history_candles(self, params: PublicGetSpotFeedHistoryCandlesParamsSchema,) -> PublicGetSpotFeedHistoryCandlesResponseSchema:
    ...
    def get_funding_rate_history(self, params: PublicGetFundingRateHistoryParamsSchema,) -> PublicGetFundingRateHistoryResponseSchema:
    ...
    def get_trade_history(self, params: PublicGetTradeHistoryParamsSchema,) -> PublicGetTradeHistoryResponseSchema:
    ...
    def get_option_settlement_history(self, params: PublicGetOptionSettlementHistoryParamsSchema,) -> PublicGetOptionSettlementHistoryResponseSchema:
    ...
    def get_liquidation_history(self, params: PublicGetLiquidationHistoryParamsSchema,) -> PublicGetLiquidationHistoryResponseSchema:
    ...
    def get_interest_rate_history(self, params: PublicGetInterestRateHistoryParamsSchema,) -> PublicGetInterestRateHistoryResponseSchema:
    ...
    def get_transaction(self, params: PublicGetTransactionParamsSchema,) -> PublicGetTransactionResponseSchema:
    ...
    def get_margin(self, params: PublicGetMarginParamsSchema,) -> PublicGetMarginResponseSchema:
    ...
    def margin_watch(self, params: PublicMarginWatchParamsSchema,) -> PublicMarginWatchResponseSchema:
    ...
    def get_vault_share(self, params: PublicGetVaultShareParamsSchema,) -> PublicGetVaultShareResponseSchema:
    ...
    def get_vault_statistics(self, params: PublicGetVaultStatisticsParamsSchema,) -> PublicGetVaultStatisticsResponseSchema:
    ...
    def get_vault_balances(self, params: PublicGetVaultBalancesParamsSchema,) -> PublicGetVaultBalancesResponseSchema:
    ...
    def create_subaccount_debug(self, params: PublicCreateSubaccountDebugParamsSchema,) -> PublicCreateSubaccountDebugResponseSchema:
    ...
    def deposit_debug(self, params: PublicDepositDebugParamsSchema,) -> PublicDepositDebugResponseSchema:
    ...
    def withdraw_debug(self, params: PublicWithdrawDebugParamsSchema,) -> PublicWithdrawDebugResponseSchema:
    ...
    def send_quote_debug(self, params: PublicSendQuoteDebugParamsSchema,) -> PublicSendQuoteDebugResponseSchema:
    ...
    def execute_quote_debug(self, params: PublicExecuteQuoteDebugParamsSchema,) -> PublicExecuteQuoteDebugResponseSchema:
    ...
    def get_time(self, params: PublicGetTimeParamsSchema,) -> PublicGetTimeResponseSchema:
    ...
    def get_live_incidents(self, params: PublicGetLiveIncidentsParamsSchema,) -> PublicGetLiveIncidentsResponseSchema:
    ...
    def get_maker_programs(self, params: PublicGetMakerProgramsParamsSchema,) -> PublicGetMakerProgramsResponseSchema:
    ...
    def get_maker_program_scores(self, params: PublicGetMakerProgramScoresParamsSchema,) -> PublicGetMakerProgramScoresResponseSchema:
    ...
    def get_referral_performance(self, params: PublicGetReferralPerformanceParamsSchema,) -> PublicGetReferralPerformanceResponseSchema:
...
class PrivateAPI:
    ...
    def get_account(self, params: PrivateGetAccountParamsSchema,) -> PrivateGetAccountResponseSchema:
    ...
    def create_subaccount(self, params: PrivateCreateSubaccountParamsSchema,) -> PrivateCreateSubaccountResponseSchema:
    ...
    def get_subaccount(self, params: PrivateGetSubaccountParamsSchema,) -> PrivateGetSubaccountResponseSchema:
    ...
    def get_subaccounts(self, params: PrivateGetSubaccountsParamsSchema,) -> PrivateGetSubaccountsResponseSchema:
    ...
    def get_all_portfolios(self, params: PrivateGetAllPortfoliosParamsSchema,) -> PrivateGetAllPortfoliosResponseSchema:
    ...
    def change_subaccount_label(self, params: PrivateChangeSubaccountLabelParamsSchema,) -> PrivateChangeSubaccountLabelResponseSchema:
    ...
    def get_notifications(self, params: PrivateGetNotificationsParamsSchema,) -> PrivateGetNotificationsResponseSchema:
    ...
    def update_notifications(self, params: PrivateUpdateNotificationsParamsSchema,) -> PrivateUpdateNotificationsResponseSchema:
    ...
    def deposit(self, params: PrivateDepositParamsSchema,) -> PrivateDepositResponseSchema:
    ...
    def withdraw(self, params: PrivateWithdrawParamsSchema,) -> PrivateWithdrawResponseSchema:
    ...
    def transfer_erc20(self, params: PrivateTransferErc20ParamsSchema,) -> PrivateTransferErc20ResponseSchema:
    ...
    def transfer_position(self, params: PrivateTransferPositionParamsSchema,) -> PrivateTransferPositionResponseSchema:
    ...
    def transfer_positions(self, params: PrivateTransferPositionsParamsSchema,) -> PrivateTransferPositionsResponseSchema:
    ...
    def order(self, params: PrivateOrderParamsSchema,) -> PrivateOrderResponseSchema:
    ...
    def replace(self, params: PrivateReplaceParamsSchema,) -> PrivateReplaceResponseSchema:
    ...
    def order_debug(self, params: PrivateOrderDebugParamsSchema,) -> PrivateOrderDebugResponseSchema:
    ...
    def get_order(self, params: PrivateGetOrderParamsSchema,) -> PrivateGetOrderResponseSchema:
    ...
    def get_orders(self, params: PrivateGetOrdersParamsSchema,) -> PrivateGetOrdersResponseSchema:
    ...
    def get_open_orders(self, params: PrivateGetOpenOrdersParamsSchema,) -> PrivateGetOpenOrdersResponseSchema:
    ...
    def cancel(self, params: PrivateCancelParamsSchema,) -> PrivateCancelResponseSchema:
    ...
    def cancel_all(self, params: PrivateCancelAllParamsSchema,) -> PrivateCancelAllResponseSchema:
    ...
    def cancel_by_label(self, params: PrivateCancelByLabelParamsSchema,) -> PrivateCancelByLabelResponseSchema:
    ...
    def cancel_by_nonce(self, params: PrivateCancelByNonceParamsSchema,) -> PrivateCancelByNonceResponseSchema:
    ...
    def cancel_by_instrument(self, params: PrivateCancelByInstrumentParamsSchema,) -> PrivateCancelByInstrumentResponseSchema:
    ...
    def cancel_trigger_order(self, params: PrivateCancelTriggerOrderParamsSchema,) -> PrivateCancelTriggerOrderResponseSchema:
    ...
    def get_order_history(self, params: PrivateGetOrderHistoryParamsSchema,) -> PrivateGetOrderHistoryResponseSchema:
    ...
    def get_trade_history(self, params: PrivateGetTradeHistoryParamsSchema,) -> PrivateGetTradeHistoryResponseSchema:
    ...
    def get_deposit_history(self, params: PrivateGetDepositHistoryParamsSchema,) -> PrivateGetDepositHistoryResponseSchema:
    ...
    def get_withdrawal_history(self, params: PrivateGetWithdrawalHistoryParamsSchema,) -> PrivateGetWithdrawalHistoryResponseSchema:
    ...
    def send_rfq(self, params: PrivateSendRfqParamsSchema,) -> PrivateSendRfqResponseSchema:
    ...
    def cancel_rfq(self, params: PrivateCancelRfqParamsSchema,) -> PrivateCancelRfqResponseSchema:
    ...
    def cancel_batch_rfqs(self, params: PrivateCancelBatchRfqsParamsSchema,) -> PrivateCancelBatchRfqsResponseSchema:
    ...
    def get_rfqs(self, params: PrivateGetRfqsParamsSchema,) -> PrivateGetRfqsResponseSchema:
    ...
    def poll_rfqs(self, params: PrivatePollRfqsParamsSchema,) -> PrivatePollRfqsResponseSchema:
    ...
    def send_quote(self, params: PrivateSendQuoteParamsSchema,) -> PrivateSendQuoteResponseSchema:
    ...
    def cancel_quote(self, params: PrivateCancelQuoteParamsSchema,) -> PrivateCancelQuoteResponseSchema:
    ...
    def cancel_batch_quotes(self, params: PrivateCancelBatchQuotesParamsSchema,) -> PrivateCancelBatchQuotesResponseSchema:
    ...
    def get_quotes(self, params: PrivateGetQuotesParamsSchema,) -> PrivateGetQuotesResponseSchema:
    ...
    def poll_quotes(self, params: PrivatePollQuotesParamsSchema,) -> PrivatePollQuotesResponseSchema:
    ...
    def execute_quote(self, params: PrivateExecuteQuoteParamsSchema,) -> PrivateExecuteQuoteResponseSchema:
    ...
    def rfq_get_best_quote(self, params: PrivateRfqGetBestQuoteParamsSchema,) -> PrivateRfqGetBestQuoteResponseSchema:
    ...
    def get_margin(self, params: PrivateGetMarginParamsSchema,) -> PrivateGetMarginResponseSchema:
    ...
    def get_collaterals(self, params: PrivateGetCollateralsParamsSchema,) -> PrivateGetCollateralsResponseSchema:
    ...
    def get_positions(self, params: PrivateGetPositionsParamsSchema,) -> PrivateGetPositionsResponseSchema:
    ...
    def get_option_settlement_history(self, params: PrivateGetOptionSettlementHistoryParamsSchema,) -> PrivateGetOptionSettlementHistoryResponseSchema:
    ...
    def get_subaccount_value_history(self, params: PrivateGetSubaccountValueHistoryParamsSchema,) -> PrivateGetSubaccountValueHistoryResponseSchema:
    ...
    def expired_and_cancelled_history(self, params: PrivateExpiredAndCancelledHistoryParamsSchema,) -> PrivateExpiredAndCancelledHistoryResponseSchema:
    ...
    def get_funding_history(self, params: PrivateGetFundingHistoryParamsSchema,) -> PrivateGetFundingHistoryResponseSchema:
    ...
    def get_interest_history(self, params: PrivateGetInterestHistoryParamsSchema,) -> PrivateGetInterestHistoryResponseSchema:
    ...
    def get_erc20_transfer_history(self, params: PrivateGetErc20TransferHistoryParamsSchema,) -> PrivateGetErc20TransferHistoryResponseSchema:
    ...
    def get_liquidation_history(self, params: PrivateGetLiquidationHistoryParamsSchema,) -> PrivateGetLiquidationHistoryResponseSchema:
    ...
    def liquidate(self, params: PrivateLiquidateParamsSchema,) -> PrivateLiquidateResponseSchema:
    ...
    def get_liquidator_history(self, params: PrivateGetLiquidatorHistoryParamsSchema,) -> PrivateGetLiquidatorHistoryResponseSchema:
    ...
    def session_keys(self, params: PrivateSessionKeysParamsSchema,) -> PrivateSessionKeysResponseSchema:
    ...
    def edit_session_key(self, params: PrivateEditSessionKeyParamsSchema,) -> PrivateEditSessionKeyResponseSchema:
    ...
    def register_scoped_session_key(self, params: PrivateRegisterScopedSessionKeyParamsSchema,) -> PrivateRegisterScopedSessionKeyResponseSchema:
    ...
    def get_mmp_config(self, params: PrivateGetMmpConfigParamsSchema,) -> PrivateGetMmpConfigResponseSchema:
    ...
    def set_mmp_config(self, params: PrivateSetMmpConfigParamsSchema,) -> PrivateSetMmpConfigResponseSchema:
    ...
    def reset_mmp(self, params: PrivateResetMmpParamsSchema,) -> PrivateResetMmpResponseSchema:
    ...
    def set_cancel_on_disconnect(self, params: PrivateSetCancelOnDisconnectParamsSchema,) -> PrivateSetCancelOnDisconnectResponseSchema:
