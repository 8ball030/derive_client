...
class TransactionOperations:
    ...
    async def get(self, *, transaction_id: str) -> PublicGetTransactionResultSchema:
        """Get a transaction by its transaction id."""

        params = PublicGetTransactionParamsSchema(transaction_id=transaction_id)
        response = await self._subaccount._public_api.get_transaction(params)
    ...
    async def deposit_to_subaccount(
        ...
        *,
        ...
        response = await self._subaccount._private_api.deposit(params)
        return response.result
    ...
    async def withdraw_from_subaccount(
        ...
        *,
        ...
        response = await self._subaccount._private_api.withdraw(params)
        return response.result
