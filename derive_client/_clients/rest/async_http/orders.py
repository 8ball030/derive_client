...
class OrderOperations:
    ...
    async def create(
        ...
        *,
        ...
        response = await self._subaccount._private_api.order(params)
    ...
    async def get(self, *, order_id: str) -> PrivateGetOrderResultSchema:
        ...
        response = await self._subaccount._private_api.get_order(params)
        return response.result
    ...
    async def list(
        ...
        *,
        ...
        response = await self._subaccount._private_api.get_orders(params)
        return response.result

    async def list_open(self) -> PrivateGetOpenOrdersResultSchema:
    ...
    async def cancel(self, *, instrument_name: str, order_id: str) -> PrivateCancelResultSchema:
        params = PrivateCancelParamsSchema(
            instrument_name=instrument_name,
            order_id=order_id,
            subaccount_id=self._subaccount.id,
        )
        response = await self._subaccount._private_api.cancel(params)
        return response.result

    async def cancel_by_label(self, *, label: str, instrument_name: Optional[str] = None) -> PrivateCancelByLabelResultSchema:
        params = PrivateCancelByLabelParamsSchema(
            label=label,
            instrument_name=instrument_name,
            subaccount_id=self._subaccount.id,
        )
        response = await self._subaccount._private_api.cancel_by_label(params)
        return response.result

    async def cancel_by_nonce(self, *, instrument_name: str, nonce: int) -> PrivateCancelByNonceResultSchema:
        ...
        response = await self._subaccount._private_api.cancel_by_nonce(params)
        return response.result
    ...
    async def cancel_by_instrument(self, *, instrument_name: str) -> PrivateCancelByInstrumentResultSchema:
        ...
        response = await self._subaccount._private_api.cancel_by_instrument(params)
        return response.result
    ...
    async def replace(
        ...
        *,
        ...
        response = await self._subaccount._private_api.replace(params)
        return response.result
