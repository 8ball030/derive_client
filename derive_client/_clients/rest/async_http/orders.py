...
class OrderOperations:
    ...
    async def create(
        ...
        *,
        ...
        result = await self._subaccount._private_api.order(params)
        return result.order
    ...
    async def get(self, *, order_id: str) -> PrivateGetOrderResultSchema:
        ...
        result = await self._subaccount._private_api.get_order(params)
        return result
    ...
    async def list(
        ...
        *,
        ...
        result = await self._subaccount._private_api.get_orders(params)
    ...
    async def list_open(self) -> List[OrderResponseSchema]:
        ...
        result = await self._subaccount._private_api.get_open_orders(params)
        return result.orders
    ...
    async def cancel(
        ...
        *,
        ...
        result = await self._subaccount._private_api.cancel(params)
        return result
    ...
    async def cancel_by_label(
        ...
        *,
        ...
        result = await self._subaccount._private_api.cancel_by_label(params)
        return result
    ...
    async def cancel_by_nonce(
        ...
        *,
        ...
        result = await self._subaccount._private_api.cancel_by_nonce(params)
        return result
    ...
    async def cancel_by_instrument(self, *, instrument_name: str) -> PrivateCancelByInstrumentResultSchema:
        ...
        result = await self._subaccount._private_api.cancel_by_instrument(params)
        return result
    ...
    async def cancel_all(self) -> Result:
        ...
        result = await self._subaccount._private_api.cancel_all(params)
        return result
    ...
    async def replace(
        ...
        *,
        ...
        result = await self._subaccount._private_api.replace(params)
        return result
