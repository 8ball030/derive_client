...
def get_volatility(currency: str = "BTC", start_timestamp: int = None, end_timestamp: int = None, resolution: int = "1D"):
...
def get_black_scholes_data(
    ...
    cost =  py_vollib.black_scholes.black_scholes(side.lower(), current_stock_price, strike_price, t, risk_free_rate, sigma)
    delta = py_vollib.black_scholes.greeks.numerical.delta(side.lower(), current_stock_price, strike_price, t, risk_free_rate, sigma,)
    gamma = py_vollib.black_scholes.greeks.numerical.gamma(side.lower(), current_stock_price, strike_price, t, risk_free_rate, sigma,)
    theta = py_vollib.black_scholes.greeks.numerical.theta(side.lower(), current_stock_price, strike_price, t, risk_free_rate, sigma,)
